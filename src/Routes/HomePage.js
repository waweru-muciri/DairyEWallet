...
const appFeatures = [
        ...
        through rental agreements, unit recurring and one-time charges, current and previous tenants, availability status.`},
    {
        ...
        rent and other charges, charges and sales statements, tenants sales history`},
    {
        ...
        Track rent and other charges, sales, products
        and reconcile property income statments.`},
    {
        icon: <WorkIcon style={{ color: "#3f51b5" }} fontSize="large" />, title: "Rental Agreements",
        description: `Track and manage rental agreements, sale schedules, record sale sales on agreements, 
...
const appModules = [
    {
        ...
        occupancy, rent charges and sales through smart analytics, summaries and charts`},
    {
        image: "/tenantDetails.png", title: "Tenant Details & Summary",
        description: `Track individual tenant details, charges and sales statements, units history, rental agreements
        start and end dates through smart analytics, summaries and charts etc.`},
    {
        image: "/rentRoll.png", title: "Rent Roll",
        description: `Get a detailed view of each property rental agreements rent charges, rent sales, 
        rent outstanding balances, monthly and yearly rent income statements.`},
    {
        image: "/rentalAgreements.png", title: "Property Performance",
        description: `Generate property performance reports including income statements, products statements,
...
const appServices = [
    ...
    { icon: <MoneyOffIcon />, title: "Products Tracking" },
                        ...
                        <Grid item container spacing={2} alignItems="center" justify="center" direction="column">
                            ...
                            <Grid item xs={10}>
                                <Typography component="p" variant="h6" color="textSecondary" align="center">
                                    ...
                                    rent and other charges, sales to these charges, property products, property and
